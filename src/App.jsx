...
import WeeklyProgrammeBuilder from './pages/WeeklyProgrammeBuilder';
...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/WeeklyProgrammeBuilder" element={
        <LayoutWrapper currentPageName="WeeklyProgrammeBuilder">
          <WeeklyProgrammeBuilder />
        </LayoutWrapper>
      } />
