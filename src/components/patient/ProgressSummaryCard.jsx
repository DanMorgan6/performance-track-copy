...
Provide an encouraging, professional summary focused on recovery progress.`;
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-br from-purple-50 to-cyan-50 rounded-2xl p-6 border border-purple-100 shadow-sm">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl bg-purple-100 flex items-center justify-center">
            <Sparkles className="w-5 h-5 text-purple-600 animate-pulse" />
          </div>
          <h3 className="text-base font-semibold text-slate-800">Progress Insights</h3>
        </div>
  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 to-cyan-50 rounded-2xl p-6 border border-purple-100 shadow-sm">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-base font-semibold text-slate-800">Your Progress</h3>
      </div>
